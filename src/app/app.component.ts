...
export class AppComponent{
  ...
  menuItems = [
    ...
    { class: menuItemsClass.REUNION_GR_LIST, libelle: "menu.reunion_gr", icone: "group_work", habilitation: [UserRole.ResponsableGr] },
    { class: menuItemsClass.EVENT_LIST, libelle: "menu.liste_evenement", icone: "event", habilitation: [UserRole.ResponsableGr] },
